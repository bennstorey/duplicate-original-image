(function () {
  console.log("✅ A22 Plugin: Duplicate Original Image - Dossier Toolbar");
  ...
  waitForContentStationSdk(function () {
    console.log("⏳ Registering plugin with onReady lifecycle...");

    ContentStationSdk.registerPlugin({
      id: "duplicate-original-image-plugin",
      onReady: function () {
        console.log("✅ ContentStationSdk is fully ready. Registering button...");
